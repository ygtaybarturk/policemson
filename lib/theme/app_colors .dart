...
// ── DARK MODE RENK PALETİ (ÇOKSIIYAH) ──────────────────────────
const kBgDark       = Color(0xFF0D0D0D);      // Çok koyu siyah
const kBgCardDark   = Color(0xFF1A1A1A);      // Kart siyahı
const kBgCard2Dark  = Color(0xFF262626);      // İkincil kart siyahı

const kTextDark     = Color(0xFFF5F5F5);      // Neredeyse beyaz yazı
const kTextSubDark  = Color(0xFFB0B0B0);      // Açık gri alt yazı
const kTextHintDark = Color(0xFF808080);      // Daha açık gri ipucu

const kBorderDark   = Color(0xFF404040);      // Siyah border
const kDividerDark  = Color(0xFF2A2A2A);      // Siyah divider

const kGlassDark    = Color(0xE81A1A1A);      // Siyah glassmorphism

// ── Durum renkleri (dark mode'de aynı, ama daha parlak) ───────────────
const kSuccessDark  = Color(0xFF26D07C);      // Parlak yeşil
const kWarnDark     = Color(0xFFFFB84D);      // Parlak turuncu
const kDangerDark   = Color(0xFFFF6B6B);      // Parlak kırmızı
