...
class DatabaseService {
  ...
  Future<List<Map<String, dynamic>>> aralikAnaliz(int yil, int bas, int bit) async {
    ...
    for (int ay = bas; ay <= bit; ay++) {
      ...
      // Zeyil toplamları — net kazanca dahil
      final zeyilToplam = await aylikZeyilToplam(gercekYil, gercekAy);
      final zeyilTutar    = zeyilToplam['tutar']    ?? 0;
      final zeyilKomisyon = zeyilToplam['komisyon'] ?? 0;
