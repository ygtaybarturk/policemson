                      ...
                      title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(children: [
                          if (s.sirket.isNotEmpty) ...[
                            const Icon(Icons.business_rounded, size: 11, color: Colors.grey),
                            const SizedBox(width: 4),
                            Text(s.sirket,
                        ...
                        if (s.policeNo.isNotEmpty || s.belgeSeriNo.isNotEmpty)
                          Row(children: [
                            if (s.policeNo.isNotEmpty) ...[
                              const Icon(Icons.numbers_rounded, size: 11, color: Colors.grey),
                            ...
                            if (s.belgeSeriNo.isNotEmpty) ...[
                              const Icon(Icons.confirmation_number_outlined, size: 11, color: Colors.grey),
                              const SizedBox(width: 3),
