      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _kpiKarti('💰','Gelir',_paraFmt, Colors.orange),
            _kpiKarti('📈','Başarı','${_basariOrani.toStringAsFixed(1)}%',
    ...
    return Column(
      children: [
        ...
        Row(children: [
          ...
          _hucre('Yap.M.', bold:true, renk:Colors.red.shade600),
          _hucre('Gelir', bold:true, renk:Colors.orange.shade700, flex:2),
        ]),
        ...
        ..._veri.map((r) {
          ...
          return Row(children: [
            ...
            _hucre('$yap2', renk:Colors.red.shade600),
