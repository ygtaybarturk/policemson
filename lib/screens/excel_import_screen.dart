...
class _ExcelSatir {
  ...
  Police toPolice() {
    // Başlangıç tarihi varsa onu kullan, yoksa bugünü kullan
    final bas = baslangic ?? DateTime.now();
    final bit = bitis ?? bas.add(const Duration(days: 365));
    // Başlangıç tarihi geçmişte veya bugün ise → yapildi, ileride ise → beklemede
    final simdi = DateTime.now();
    final durumDeger = (bas.isBefore(simdi) || 
    ...
    return Police(
      ...
      durum: durumDeger,
      // olusturmaTarihi = baslangicTarihi → poliçe başladığı aya görünsün
      olusturmaTarihi: bas,
    );
  }
}
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Icon(Icons.table_chart_outlined, size: 40, color: kPrimary),
        ),
        ...
        Text('TC Kimlik, Poliçe Türü, Belge No ve Plaka\notomatik olarak Excel\'den okunur',
          ...
          style: TextStyle(fontSize: 13, color: kText.withOpacity(0.6), height: 1.5)),
        ...
        if (_hatalar.isNotEmpty) Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [Icon(Icons.error_outline, color: kDanger, size: 16), const SizedBox(width:6),
              Text('Hata', style: TextStyle(fontWeight: FontWeight.w800, color: kDanger))]),
            const SizedBox(height: 6),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Text('Desteklenen Excel Sütunları',
                style: TextStyle(fontWeight: FontWeight.w800, fontSize: 13, color: kPrimary)),
            ]),
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, i) {
            ...
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isEdit
                    ? const Color(0xFFDDE6FF).withOpacity(0.4)
                    : Theme.of(context).cardTheme.color,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: s.hata != null ? kDanger.withOpacity(0.5)
                      : on ? kPrimary : Theme.of(context).dividerColor,
                  width: on && !isEdit ? 1.5 : 1,
                ),
                boxShadow: on && !isEdit ? [BoxShadow(
                  color: kPrimary.withOpacity(0.08), blurRadius: 8)] : [],
              ),
              child: isEdit
      ...
      Container(
        ...
        child: SafeArea(child: Row(children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('$_seciliSayi poliçe', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 15, color: kText)),
            Text('aktarılacak', style: TextStyle(fontSize: 11, color: kText.withOpacity(0.5))),
          ]),
          const Spacer(),
          FilledButton.icon(
      ...
      child: Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (s.hata == null)
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: on ? kPrimary : Theme.of(context).dividerColor, width: 2),
            ...
            Icon(Icons.error_outline, size: 22, color: kDanger),
          const SizedBox(width: 10),
          // Tür emoji
          Container(
            width: 36, height: 36,
            decoration: BoxDecoration(color: const Color(0xFFDDE6FF), borderRadius: BorderRadius.circular(10)),
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFFDDE6FF), borderRadius: BorderRadius.circular(7)),
                child: Text(s.tur.adi, style: TextStyle(fontSize: 9.5, fontWeight: FontWeight.w800, color: kPrimary)),
              ),
            ]),
            ...
            Wrap(spacing: 10, runSpacing: 4, children: [
              ...
              if (s.hata != null)
                _MetaChip(icon: Icons.warning_amber_outlined, text: s.hata!, cs: cs, color: kDanger),
            ]),
          ])),
          // Düzenle butonu
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.edit_outlined, size: 14, color: kText.withOpacity(0.6)),
            ),
          ),
        ]),
      ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Text('✏️ Düzenle — ${s.musteriAdi}',
            style: TextStyle(fontWeight: FontWeight.w800, fontSize: 12.5, color: kPrimary)),
          const Spacer(),
          IconButton(
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Text('Tüm poliçeler başarıyla sisteme aktarıldı',
          style: TextStyle(fontSize: 13, color: kText.withOpacity(0.6))),
        const SizedBox(height: 28),
        Row(children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Tür Dağılımı', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 13, color: kPrimary)),
            const SizedBox(height: 10),
            ...byTur.entries.map((e) {
              ...
              return Padding(
                ...
                child: Row(children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: const Color(0xFFDDE6FF), borderRadius: BorderRadius.circular(8)),
                    child: Text('${e.value}', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 12, color: kPrimary)),
                  ),
                ]),
              );
            }),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        TextButton(
          ...
          child: Text('Tümünü Seç', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: kPrimary)),
        ),
      ]),
    );
  }
...
class _OzetChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Text(label, style: TextStyle(fontSize: 9.5, color: kText.withOpacity(0.5), fontWeight: FontWeight.w700)),
    Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: kPrimary)),
  ]);
}
...
class _MetaChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(mainAxisSize: MainAxisSize.min, children: [
    Icon(icon, size: 11, color: color ?? kText.withOpacity(0.45)),
    const SizedBox(width: 3),
    Text(text, style: TextStyle(fontSize: 11, color: color ?? kText.withOpacity(0.7),
...
class _OzetKart extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    padding: const EdgeInsets.all(14),
    decoration: BoxDecoration(color: const Color(0xFFDDE6FF), borderRadius: BorderRadius.circular(16)),
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(icon, style: const TextStyle(fontSize: 22)),
      const SizedBox(height: 6),
      Text(value, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: kPrimary)),
      Text(label, style: TextStyle(fontSize: 11, color: kPrimary.withOpacity(0.7), fontWeight: FontWeight.w600)),
    ]),
  );
}
