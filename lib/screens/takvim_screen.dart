          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                color: isDark ? kBgCard2Dark : kBgCard,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: isDark ? kBorderDark : kBorder,
                ),
                boxShadow: [
                  BoxShadow(
                ...
                child: TableCalendar(
                  ...
                  calendarStyle: CalendarStyle(
                    ...
                    todayDecoration: BoxDecoration(
                      color: kSuccessDark.withOpacity(0.7),
                    ...
                    outsideTextStyle: TextStyle(
                      color: isDark ? kTextSubDark.withOpacity(0.4) : kTextSub.withOpacity(0.4),
                      fontWeight: FontWeight.w500,
                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 12,
                            color: isDark ? kTextSubDark : kTextSub,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
