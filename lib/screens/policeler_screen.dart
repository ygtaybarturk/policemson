            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (p.policeNo != null && p.policeNo!.isNotEmpty) ...[
                  Row(children: [
                    Icon(Icons.numbers_rounded, size: 12, color: kTextSub),
                    const SizedBox(width: 5),
                ...
                Row(children: [
                  Icon(Icons.calendar_today_outlined, size: 13, color: kTextSub),
                  const SizedBox(width: 5),
                  Text(fmt.format(p.baslangicTarihi),
                      style: TextStyle(fontSize: 11, color: kText, fontWeight: FontWeight.w700)),
                  const SizedBox(width: 8),
