    ...
    Expanded(
      child: _yukl
          ...
          : _liste.isEmpty && _zeyiller.isEmpty
              ? _bosEkran()
              : ListView(
                  padding: const EdgeInsets.fromLTRB(10, 3, 10, 90),
                  cacheExtent: 800,
                  children: [
                    if (_liste.isEmpty)
                      _bosEkran()
              ...
              Container(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text(p.tur.emoji, style: const TextStyle(fontSize: 17))),
                  ),
                  const SizedBox(width: 8),
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      ...
                      Flexible(child: Text(p.sirket,
                          style: TextStyle(fontSize: 9, color: Colors.white.withOpacity(0.82), fontWeight: FontWeight.w600),
                          overflow: TextOverflow.ellipsis)),
                      if (bireySayisi > 1) ...[
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    // Başlangıç
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Başl.', style: const TextStyle(fontSize: 8, color: kTextHint, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 1),
                      Text(fmt.format(p.baslangicTarihi),
                          style: const TextStyle(fontSize: 9.5, color: kText, fontWeight: FontWeight.w700)),
                    ])),
                    // Ok
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.arrow_forward_rounded, size: 8, color: kTextSub),
                      ),
                    ),
                    // Bitiş
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                Row(children: [
                  ...
                  if (isYapildi)
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        const Icon(Icons.check_circle_rounded, size: 9, color: kSuccess),
                        const SizedBox(width: 2),
                        const Text('Yapıldı',
                            style: TextStyle(fontSize: 8.5, fontWeight: FontWeight.w700, color: kSuccess)),
                      ]),
                    ),
                  if (p.durum == PoliceStatus.yapilamadi)
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        const Icon(Icons.cancel_rounded, size: 9, color: kDanger),
                        const SizedBox(width: 2),
                        const Text('Yapılamadı',
                            style: TextStyle(fontSize: 8.5, fontWeight: FontWeight.w700, color: kDanger)),
                      ]),
                    ),
                  if (p.durum == PoliceStatus.dahaSonra)
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        const Icon(Icons.watch_later_rounded, size: 9, color: kWarn),
                        const SizedBox(width: 2),
                        const Text('Daha Sonra',
                            style: TextStyle(fontSize: 8.5, fontWeight: FontWeight.w700, color: kWarn)),
                      ]),
                    ),
                ]),
                ...
                if (toplamTutar > 0) ...[
                  const SizedBox(height: 5),
                  Row(children: [
                    const Icon(Icons.payments_outlined, size: 9, color: kTextSub),
                    const SizedBox(width: 3),
                    Text('Prim: ', style: const TextStyle(fontSize: 9, color: kTextSub)),
                    Text(moneyFmt.format(toplamTutar),
...
class _KalanGunPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (yapildi) {
      return Container(
        ...
        child: Text(kalanGun > 0 ? '📅 $kalanGun gün' : '🏁 Bitti',
            style: const TextStyle(fontSize: 8.5, fontWeight: FontWeight.w700, color: kSuccess)),
      );
    }
    ...
    return Container(
      ...
      child: Text(t, style: TextStyle(fontSize: 8.5, fontWeight: FontWeight.w700, color: fg)),
    );
  }
}
...
class _ActBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => OutlinedButton.icon(
    onPressed: onTap,
    icon: Icon(secili ? _doluIcon(icon) : icon, size: 9),
    label: Text(label, style: TextStyle(fontSize: 8.5, letterSpacing: -0.2, fontWeight: secili ? FontWeight.w800 : FontWeight.w600)),
    style: OutlinedButton.styleFrom(
