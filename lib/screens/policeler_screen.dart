...
class _PoliceKarti extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Bu kart bitiş tarihine mi ait başlangıç tarihine mi?
    // (Kart gösterildiği aya göre belirlenir)
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Padding(
                    ...
                    child: Icon(Icons.arrow_forward, size: 11, color: cs.onSurface.withOpacity(0.3)),
                  ),
                ...
                Wrap(spacing: 6, runSpacing: 4, children: [
                  ...
                  // Yapıldı badge (durum yapildi ise)
                  if (p.durum == PoliceStatus.yapildi)
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                      decoration: BoxDecoration(
                ...
                Container(
                  ...
                  child: Column(children: [
                    // Yapıldı / Yapılamadı / Daha Sonra butonları
                    if (showBtn) ...[ 
                      Row(children: [
                        ...
                        const SizedBox(width: 5),
                        Expanded(child: _ActBtn(label: 'Sonra', icon: Icons.access_time_outlined, color: const Color(0xFFE65100), onTap: onDahaSonra)),
                      ]),
                      const SizedBox(height: 6),
                    ],
                    // Bilgiler butonu her zaman en altta
                    SizedBox(
                      ...
                      child: FilledButton.tonal(
                        ...
                        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          SizedBox(width: 6),
                          Text('Bilgiler', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800)),
                        ]),
                      ),
                    ),
                  ]),
