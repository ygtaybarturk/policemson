              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    if (showBtn) ...[
                      Row(children: [
                        Expanded(child: _ActBtn('Yapıldı',    Icons.check_circle_outline_rounded, kSuccess, onYapildi,    secili: p.durum == PoliceStatus.yapildi)),
                        const SizedBox(width: 6),
                        Expanded(child: _ActBtn('Yapılamadı', Icons.cancel_outlined,              kDanger,  onYapilamadi, secili: p.durum == PoliceStatus.yapilamadi)),
                        const SizedBox(width: 6),
                        Expanded(child: _ActBtn('Sonra',      Icons.watch_later_outlined,         kWarn,    onDahaSonra,  secili: p.durum == PoliceStatus.dahaSonra)),
                      ]),
                      const SizedBox(height: 8),
                    ],
