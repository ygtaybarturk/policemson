          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: on ? kPrimary : (isDark ? kBgCard2Dark : kBgCard2),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
                    color: on ? kPrimary : (isDark ? kBorderDark : kBorder),
                    width: on ? 1.5 : 1,
                  ),
                  boxShadow: on ? [BoxShadow(color: kPrimary.withOpacity(0.22), blurRadius: 6, offset: const Offset(0,2))] : [],
                ),
                child: Text(_filtreler[i].$1, style: TextStyle(
                  fontSize: 11.5,
                  fontWeight: FontWeight.w700,
                  color: on ? Colors.white : (isDark ? kTextDark : kText),
                )),
              ),
            );
          },
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        height: 34,
        decoration: BoxDecoration(
          color: isDark ? kBgCard2Dark : kBgCard2,
          borderRadius: BorderRadius.circular(11),
          border: Border.all(color: isDark ? kBorderDark : kBorder),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: Theme.of(context).brightness == Brightness.dark ? kBgCard2Dark : kBgCard,
            borderRadius: BorderRadius.circular(22),
            border: Border.all(
              color: acil ? kDanger.withOpacity(0.35) : (Theme.of(context).brightness == Brightness.dark ? kBorderDark : kBorder),
              width: acil ? 1.2 : 0.8,
            ),
            boxShadow: [
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (p.policeNo != null && p.policeNo!.isNotEmpty) ...[
                  Row(children: [
                    Icon(Icons.numbers_rounded, size: 12, color: Theme.of(context).brightness == Brightness.dark ? kTextSubDark : kTextSub),
                    const SizedBox(width: 5),
                    Expanded(child: Text('Poliçe No: ${p.policeNo!}',
                        style: TextStyle(fontSize: 11, color: Theme.of(context).brightness == Brightness.dark ? kTextSubDark : kTextSub, fontWeight: FontWeight.w600),
                        overflow: TextOverflow.ellipsis)),
                  ]),
                  const SizedBox(height: 8),
                ],
                ...
                Row(children: [
                  Icon(Icons.calendar_today_outlined, size: 13, color: Theme.of(context).brightness == Brightness.dark ? kTextSubDark : kTextSub),
                  const SizedBox(width: 5),
                  Text(fmt.format(p.baslangicTarihi),
                      style: TextStyle(fontSize: 11, color: Theme.of(context).brightness == Brightness.dark ? kTextDark : kText, fontWeight: FontWeight.w700)),
                  const SizedBox(width: 8),
                  Text('→', style: TextStyle(color: (Theme.of(context).brightness == Brightness.dark ? kTextSubDark : kTextSub).withOpacity(0.6), fontSize: 11)),
                  const SizedBox(width: 8),
                  Expanded(child: Text(fmt.format(p.bitisTarihi),
                      style: TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700,
                        color: acil ? kDanger : (Theme.of(context).brightness == Brightness.dark ? kTextDark : kText),
                      ))),
                ]),
                const SizedBox(height: 6),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                      top: BorderSide(
                        color: Theme.of(context).brightness == Brightness.dark ? kDividerDark : kDivider,
                      ),
                    ),
                  ),
                  child: SizedBox(
                    width: double.infinity,
                    child: Material(
                      color: accent.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.12 : 0.06),
                      borderRadius: BorderRadius.circular(13),
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(13),
                            border: Border.all(color: accent.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.35 : 0.22)),
                          ),
